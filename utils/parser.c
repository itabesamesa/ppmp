...
error interprate(text t) {
	func functions[62] = { 
		...
		//./utils/xdg-shell-client-protocol.h
		//./utils/pngtopng.h
		{"openimg",                         7,        1,          1, 1, 0},
		...
		{"div_clip",                        8,        2,          8, 1, 0},
		//./utils/blend.h
		{"blend_multply",                   13,       2,          0, 1, 0},
		{"blend_screen",                    12,       2,          0, 1, 0},
		{"blend_overlay",                   13,       2,          0, 1, 0},
		{"blend_hard_light",                16,       2,          0, 1, 0},
		{"blend_soft_light_photoshop",      26,       2,          0, 1, 0},
		{"blend_soft_light_pegtop",         23,       2,          0, 1, 0},
		{"blend_soft_light_illusion_hu",    28,       2,          0, 1, 0},
		{"blend_soft_light_w3c",            20,       2,          0, 1, 0},
		{"blend_color_dodge",               17,       2,          0, 1, 0},
		{"blend_linear_dodge",              18,       2,          0, 1, 0},
		{"blend_color_burn",                16,       2,          0, 1, 0},
		{"blend_linear_burn",               17,       2,          0, 1, 0},
		{"blend_vivid_light",               17,       2,          0, 1, 0},
		{"blend_linear_light",              18,       2,          0, 1, 0},
		{"blend_divide",                    12,       2,          0, 1, 0},
		{"blend_add",                       9,        2,          0, 1, 0},
		{"blend_subtract",                  14,       2,          0, 1, 0},
		{"blend_difference",                16,       2,          0, 1, 0},
		{"blend_darken_only",               17,       2,          0, 1, 0},
		{"blend_lighten_only",              18,       2,          0, 1, 0},
		{"blend_average",                   13,       2,          0, 1, 0},
		//./utils/text.h
		//./utils/edge_detect.h
		{"edge_detect_sobel",               17,       1,          0, 1, 0},
		{"edge_detect_ridge_edge",          22,       1,          0, 1, 0},
		{"edge_detect_prewitt",             19,       1,          0, 1, 0},
		{"edge_detect_kirsch",              18,       1,          0, 1, 0},
		{"edge_detect_kirsch_color",        24,       1,          0, 1, 0}
	}; //--END--
	int functionslen = 62;
			...
			if(line[0] == DEF_VAR) { //doesn't consider there being spaces infront of '$'
				...
				switch(selectedfunction) { //--startswitch--
					...
					case 9:
						...
						images.list[outputimg] = img_HSL_to_RGB(images.list[variables.v[options.v[0]].img]);
						break;
					case 10:
						printf("img_RGB_to_HSL\n");
						images.list[outputimg] = img_RGB_to_HSL(images.list[variables.v[options.v[0]].img]);
						break;
					case 11:
						printf("clip\n");
...
////(int)variables.v[options.v[0]].num, (int)variables.v[options.v[1]].num, variables.v[options.v[2]].num);
					...
					case 18:
						printf("move_img\n");
						images.list[outputimg] = move_img(images.list[variables.v[options.v[0]].img], arraytoxy(variables, options.v[1]));
						break;
					case 19:
...
////images.list[variables.v[options.v[0]].img], variables.v[options.v[1]].string);
					...
					case 35:
						...
						break;
					case 36:
						printf("blend_multply\n");
						images.list[outputimg] = blend_multply(images.list[variables.v[options.v[0]].img], images.list[variables.v[options.v[1]].img]);
						break;
					case 37:
						printf("blend_screen\n");
						images.list[outputimg] = blend_screen(images.list[variables.v[options.v[0]].img], images.list[variables.v[options.v[1]].img]);
						break;
					case 38:
						printf("blend_overlay\n");
						images.list[outputimg] = blend_overlay(images.list[variables.v[options.v[0]].img], images.list[variables.v[options.v[1]].img]);
						break;
					case 39:
						printf("blend_hard_light\n");
						images.list[outputimg] = blend_hard_light(images.list[variables.v[options.v[0]].img], images.list[variables.v[options.v[1]].img]);
						break;
					case 40:
						printf("blend_soft_light_photoshop\n");
						images.list[outputimg] = blend_soft_light_photoshop(images.list[variables.v[options.v[0]].img], images.list[variables.v[options.v[1]].img]);
						break;
					case 41:
						printf("blend_soft_light_pegtop\n");
						images.list[outputimg] = blend_soft_light_pegtop(images.list[variables.v[options.v[0]].img], images.list[variables.v[options.v[1]].img]);
						break;
					case 42:
						printf("blend_soft_light_illusion_hu\n");
						images.list[outputimg] = blend_soft_light_illusion_hu(images.list[variables.v[options.v[0]].img], images.list[variables.v[options.v[1]].img]);
						break;
					case 43:
						printf("blend_soft_light_w3c\n");
						images.list[outputimg] = blend_soft_light_w3c(images.list[variables.v[options.v[0]].img], images.list[variables.v[options.v[1]].img]);
						break;
					case 44:
						printf("blend_color_dodge\n");
						images.list[outputimg] = blend_color_dodge(images.list[variables.v[options.v[0]].img], images.list[variables.v[options.v[1]].img]);
						break;
					case 45:
						printf("blend_linear_dodge\n");
						images.list[outputimg] = blend_linear_dodge(images.list[variables.v[options.v[0]].img], images.list[variables.v[options.v[1]].img]);
						break;
					case 46:
						printf("blend_color_burn\n");
						images.list[outputimg] = blend_color_burn(images.list[variables.v[options.v[0]].img], images.list[variables.v[options.v[1]].img]);
						break;
					case 47:
						printf("blend_linear_burn\n");
						images.list[outputimg] = blend_linear_burn(images.list[variables.v[options.v[0]].img], images.list[variables.v[options.v[1]].img]);
						break;
					case 48:
						printf("blend_vivid_light\n");
						images.list[outputimg] = blend_vivid_light(images.list[variables.v[options.v[0]].img], images.list[variables.v[options.v[1]].img]);
						break;
					case 49:
						printf("blend_linear_light\n");
						images.list[outputimg] = blend_linear_light(images.list[variables.v[options.v[0]].img], images.list[variables.v[options.v[1]].img]);
						break;
					case 50:
						printf("blend_divide\n");
						images.list[outputimg] = blend_divide(images.list[variables.v[options.v[0]].img], images.list[variables.v[options.v[1]].img]);
						break;
					case 51:
						printf("blend_add\n");
						images.list[outputimg] = blend_add(images.list[variables.v[options.v[0]].img], images.list[variables.v[options.v[1]].img]);
						break;
					case 52:
						printf("blend_subtract\n");
						images.list[outputimg] = blend_subtract(images.list[variables.v[options.v[0]].img], images.list[variables.v[options.v[1]].img]);
						break;
					case 53:
						printf("blend_difference\n");
						images.list[outputimg] = blend_difference(images.list[variables.v[options.v[0]].img], images.list[variables.v[options.v[1]].img]);
						break;
					case 54:
						printf("blend_darken_only\n");
						images.list[outputimg] = blend_darken_only(images.list[variables.v[options.v[0]].img], images.list[variables.v[options.v[1]].img]);
						break;
					case 55:
						printf("blend_lighten_only\n");
						images.list[outputimg] = blend_lighten_only(images.list[variables.v[options.v[0]].img], images.list[variables.v[options.v[1]].img]);
						break;
					case 56:
						printf("blend_average\n");
						images.list[outputimg] = blend_average(images.list[variables.v[options.v[0]].img], images.list[variables.v[options.v[1]].img]);
						break;
					case 57:
						printf("edge_detect_sobel\n");
						images.list[outputimg] = edge_detect_sobel(images.list[variables.v[options.v[0]].img]);
						break;
					case 58:
						printf("edge_detect_ridge_edge\n");
						images.list[outputimg] = edge_detect_ridge_edge(images.list[variables.v[options.v[0]].img]);
						break;
					case 59:
						printf("edge_detect_prewitt\n");
						images.list[outputimg] = edge_detect_prewitt(images.list[variables.v[options.v[0]].img]);
						break;
					case 60:
						printf("edge_detect_kirsch\n");
						images.list[outputimg] = edge_detect_kirsch(images.list[variables.v[options.v[0]].img]);
						break;
					case 61:
						printf("edge_detect_kirsch_color\n");
						images.list[outputimg] = edge_detect_kirsch_color(images.list[variables.v[options.v[0]].img]);
						break;
					default:
